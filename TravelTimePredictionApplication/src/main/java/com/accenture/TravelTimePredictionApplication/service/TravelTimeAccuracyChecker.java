...
public class TravelTimeAccuracyChecker {
	...
	public static String SomeRealityCheck(String routeId) throws  Exception{
		...
		String url = "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins="+routeDetail.getOrigin()+"&destinations="+routeDetail.getDestination()+"&departure_time=now&traffic_model=best_guess&mode=driving&key=AIzaSyBHz1QUGhHoP4ziV3SJRcmOAEEMukVGxtU";
		...
		String durationInTraffic = msgObj.getJSONArray("rows")
        .getJSONObject(0)
		...
		System.out.println("destination: "+destinationAdd);
